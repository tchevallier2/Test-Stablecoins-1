  ...
  issuers: [
    {
      ...
      description:
        "The world's largest stablecoin issuer, providing liquidity and stability across global crypto markets. Tether's USDT is the most traded asset in cryptocurrency.",
...

    {
      ...
      description:
        "Circle is a global financial technology company and the issuer of USDC, a fully reserved dollar stablecoin. Circle filed for IPO in 2025 and operates under US regulatory oversight.",
...

    {
      ...
      description:
        "Sky, formerly MakerDAO, is the decentralized protocol behind the DAI and USDS stablecoins. Governed by SKY token holders, it is one of DeFi's most battle-tested protocols with over a decade of operation.",
...

    {
      ...
      description:
        "Ethena is a synthetic dollar protocol built on Ethereum. USDe is collateralized by delta-neutral positions combining staked ETH and short perpetual futures, generating yield through funding rates.",
...

    {
      ...
      description:
        "Paxos is a regulated blockchain infrastructure platform and trust company. It issues regulated stablecoins and tokenized assets, serving as the infrastructure partner for PayPal's PYUSD.",
...

    {
      ...
      description:
        "Ripple Labs is the company behind the XRP Ledger and XRP. Following years of SEC litigation, Ripple launched RLUSD in late 2024 as a fully regulated dollar stablecoin, targeting enterprise cross-border payments.",
...

    {
      ...
      description:
        "First Digital Trust is a Hong Kong-based qualified trustee and digital asset custodian. FDUSD was launched in 2023 and quickly gained traction on Binance as the primary trading stablecoin following BUSD's discontinuation.",
...

    {
      ...
      description:
        "Frax Finance is a DeFi protocol pioneering algorithmic and hybrid stablecoin designs. Frax v3 has moved toward a fully collateralized model using real-world assets and on-chain assets.",
      regulatoryStatus: "Decentralized DAO",
      stablecoins: [
        {
          ticker: "frxUSD",
...

    {
      ...
      description:
        "Ondo Finance is a tokenized real-world asset protocol focused on bringing institutional-grade financial products on-chain. USDY is their yield-bearing stablecoin backed by US Treasuries.",
